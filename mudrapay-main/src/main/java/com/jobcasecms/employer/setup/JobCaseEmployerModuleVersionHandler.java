package com.jobcasecms.employer.setup;

import com.jobcasecms.employer.templating.functions.JobcaseTemplatingFunctions;
...
public class JobCaseEmployerModuleVersionHandler extends DefaultModuleVersionHandler {
    ...
    private final Task setDefaultUriOnPublicInstance = new PropertyValueDelegateTask("Set default URI to home page", "/modules/site/config/site", "extends", "/modules/jobcase-main/config/jobcase", false,
    ...
    private final Task setupTravelSiteAsActiveSite = new NodeExistsDelegateTask("Set active site", "/modules/site/config/site",
            new PropertyExistsDelegateTask("Check extends property and update or create it", "/modules/site/config/site", "extends",
                    new CheckAndModifyPropertyValueTask("/modules/site/config/site", "extends", "/modules/standard-templating-kit/config/site", "/modules/jobcase-main/config/jobcase"),
                    new DefaultSiteExistsDelegateTask("", "",
                            new SetPropertyTask(RepositoryConstants.CONFIG, "/modules/site/config/site", "extends", "/modules/jobcase-main/config/jobcase"))),
