<link rel="stylesheet" href="${ctx.contextPath}/.resources/jobcase-main/css/components/landingPage/landingPage.css">
[@assignValues /]
     ...
     <html lang="${cmsfn.language()!}" class="no-js lt-ie9">
        ...
        <a class="navbar-logo">
         <img src="${ctx.contextPath}/.resources/jobcase-theme/images/svg/logo-jobcase-for-employers-white.svg">
           ...
           [#include "/jobcase-main/templates/pages/areas/footer-scripts.ftl"]
